...
> 3. CloudInit 更多使用方式请参考[字段说明](https://cloudinit.readthedocs.io/en/latest/reference/modules.html)和[配置示例](https://cloudinit.readthedocs.io/en/latest/reference/examples.html)。
...
虚拟机初次启动时，会根据 `cloudInit.userData` 字段进行系统初始化，该过程需要持续几分钟。用户需待初始化完成后，再使用虚拟机。

Cloud Init 配置和使用方式请参考[字段说明](https://cloudinit.readthedocs.io/en/latest/reference/modules.html)和[配置示例](https://cloudinit.readthedocs.io/en/latest/reference/examples.html)
